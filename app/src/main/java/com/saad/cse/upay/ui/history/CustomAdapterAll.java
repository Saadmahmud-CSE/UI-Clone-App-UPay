...
public class CustomAdapterAll extends RecyclerView.Adapter<CustomAdapterAll.ViewHolder>{
    public CustomAdapterAll(Context context, List<Integer> icon, List<String> title, List<String> subTitle, List<String> dateTime, List<String> money, List<String> moneySub, List<Integer> arrow) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.custom_tab_all, parent, false);
        return new CustomAdapterAll.ViewHolder(view);
    }
